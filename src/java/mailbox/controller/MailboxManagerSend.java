 ...
 */
@WebServlet(name = "MailboxManagerSend", urlPatterns = {"/mailbox-manager/mymailbox/send"})
public class MailboxManagerSend extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet MailboxManagerSend</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet MailboxManagerSend at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        getServletContext().getRequestDispatcher("/mailbox-manager/my-mailbox/form-send.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        response.sendRedirect(request.getContextPath() + "/mailbox-manager/mymailbox");
    }
