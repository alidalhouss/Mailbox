 ...
 */
@WebServlet(name = "UserListServlet", urlPatterns = {"/directory/user"})
public class UserListServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.setAttribute("messageContent", request.getParameter("messageContent"));
        request.setAttribute("connectedAs", user.getUsername());
